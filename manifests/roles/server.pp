class cloudera::roles::server (
 ...
 cloudera::api::configrolegroup{'MAPREDUCE-GATEWAY-BASE':
  ...
  cloudera::api::configrolegroup{'HDFS-SECONDARYNAMENODE-BASE':
    ...
    items_config => [{ "name" => "fs_checkpoint_dir_list", "value" => "/dfs/secondarynamenode"},{ "name" => "secondary_namenode_java_heapsize", "value" => "5368709120" }],
    cm_api_host => $cm_api_host,
    cm_api_port => $cm_api_port,
    cm_api_user => $cm_api_user,
    cm_api_pass => $cm_api_pass,
  ...
  cloudera::api::configrolegroup{'HDFS-NAMENODE-BASE':
    ...
    items_config => [{ "name" => "dfs_name_dir_list", "value" => "/nfs/namenode,/dfs/namenode" },{ "name" => "namenode_java_heapsize", "value" => "5368709120" }],
    cm_api_host => $cm_api_host,
    cm_api_port => $cm_api_port,
    cm_api_user => $cm_api_user,
    cm_api_pass => $cm_api_pass,

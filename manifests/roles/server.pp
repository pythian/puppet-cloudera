class cloudera::roles::server (
  ...
  cloudera::api::configrolegroup{'MAPREDUCE-JOBTRACKER-BASE':
    ...
    items_config => [{ "name" => "jobtracker_mapred_local_dir_list", "value" => "/dfs/mapreduce/jobtracker"},{ "name" => "mapred_reduce_tasks", "value" => "3" },{ "name" => "mapred_submit_replication", "value" => "2" },{ "name" => "mapred_job_tracker_handler_count", "value" => "25" }],
    cm_api_host => $cm_api_host,
    cm_api_port => $cm_api_port,
    cm_api_user => $cm_api_user,
    cm_api_pass => $cm_api_pass,
